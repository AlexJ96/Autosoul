                    ...
                    <div class="publish-content">
                        ...
                        <div class="publish-options">
                            <ul>
                                ...
                                <li class="publish-active"> <a href="/autosoul/admin/drafts"> Drafts  </a> </li>
                        ...
                        <div class="admin-article-overview-box">
                            ...
                            <div class="admin-article-info-bar">
                                ...
                                <p class="admin-article-info-date"> Date Updated </p>
                            </div>
                            <?php
                                ...
                                $query = $core->conn->prepare("SELECT * FROM `articles` WHERE author = 0 and status = 0");
                                $query->execute();
