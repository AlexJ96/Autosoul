                    ...
                    <div class="publish-content">
                        <div class="publish-options">
                            <ul>
                                ...
                                <li class="publish-active"> <a href="/autosoul/admin/history"> History  </a> </li>
                            </ul>
                        </div>
                        ...
                        <div class="admin-article-overview-box">
                            <div class="admin-article-action-bar">
                                <div class="admin-article-action-actions">
                                    ...
                                    <div class="admin-article-action-drop">
                                        <p class="admin-article-action-edit"> Edit </p>
                            ...
                            <?php
                                ...
                                $query = $core->conn->prepare("SELECT * FROM `articles` WHERE author = 0 and status = 2");
                                $query->execute();
