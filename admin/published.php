...
<html>
	<head>
		...
		<title>Autosoul - Published</title>
		<!-- Main CSS -->
                ...
                <div class="admin-article">
                    <div class="publish-content">
                        <div class="publish-options featured">
                            <ul>
                                <li> <a href="/autosoul/admin/featured"> Featured  </a> </li>
                                <li class="publish-active"> <a href="/autosoul/admin/published"> Published  </a> </li>
                            </ul>
                        </div>
                        ...
                        <div class="admin-article-overview-box">
                            <div class="admin-article-action-bar">
                                <div class="admin-article-action-actions">
                                    ...
                                    <div class="admin-article-action-drop">
                                        <p class="admin-article-action-feature"> Feature </p>
                                    </div>
                                </div>
                            </div>
                            <div class="admin-article-info-bar">
                                ...
                                <p class="admin-article-info-date"> Date Published </p>
                            </div>
                            <?php
                                ...
                                $query = $core->conn->prepare("SELECT * FROM `articles` WHERE author = 0 and status = 2 and featured = 0");
                                $query->execute();
